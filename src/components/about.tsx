              ...
              <div className="flex justify-start flex-col">
                ...
                >
                  <p className="mt-2 leading-relaxed text-sm text-gray-700 dark:text-white/70">
                    ...
                    customers. We strive to be the best in the industry and to
                ...
                >
                  <p className="mt-2 leading-relaxed text-sm text-gray-700 dark:text-white/70">
                    Our vision is to create custom websites that not only
                    reflect your brand but also help you achieve your business
                    objectives. From responsive design to intuitive navigation,
